...
Original works are curated from YUNO's official YouTube playlists and grouped by detailed instrumentation. `data/works.json` is the single source of truth for both original works and arrangements; edit that file directly when updating the catalog.
